...
class GeometryBuilder {
	...
	build( data ) {
		...
		if ( morphTargets.length > 0 ) if ( morphTargets.length > 0 ) geometry.morphTargets = morphTargets;
		if ( morphPositions.length > 0 ) if ( morphPositions.length > 0 ) geometry.morphAttributes.position = morphPositions;
